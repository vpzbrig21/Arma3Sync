				...
				mainPanel.add(hBox, BorderLayout.CENTER);
				{
					...
					hBox.add(panelLeft);
					{
						...
						vBox.add(Box.createVerticalStrut(10));
						{
							...
							JLabel label = new JLabel("Originally developed by the [S.o.E] Team.");
							vBox.add(label);
						}
						{
							JLabel label = new JLabel("Modified and maintained by [PzBrig21] S6.");
							vBox.add(label);
						}
						{
							JLabel label = makeHyperLink("www.vpzbrig21.de",
									"www.vpzbrig21.de");
							vBox.add(label);
						}
						vBox.add(Box.createVerticalStrut(10));
