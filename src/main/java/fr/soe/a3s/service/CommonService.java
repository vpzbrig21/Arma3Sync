...
public class CommonService {
	...
	private static String WIKI = "https://wiki.luna.vpzbrig21.de";
	private static String BIS = "https://forums.bistudio.com/showthread.php?162236-ArmA3Sync-launcher-and-addons-synchronization-software-for-ArmA-3&p=2477805#post2477805";
	private static String BISD = "https://discord.gg/arma";
	//private static String PayPal = "https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=JS65JS4FUGZWC";
	private static String PayPal = "https://paypal.me/sorotech";
	...
	public void exportLogFile(String message, String filePath) throws IOException {
		...
		String date = LOG_DATE_FORMATTER.format(ZonedDateTime.now());
