...
public class ProfileEditionDialog extends AbstractDialog {
	...
	public ProfileEditionDialog(Facade facade, ProfileSelectionDialog profileSelectionDialog, String title,
		...
		if (textFieldProfileName.getBounds().height < 25) {
			textFieldProfileName.setPreferredSize(new Dimension(this.getBounds().width, 25));
		}
