...
public class DownloadPanel extends JPanel implements UIConstants {
	...
	public DownloadPanel(Facade facade, RepositoryPanel repositoryPanel) {
		...
		}
		{
			...
			UiStyle.styleProgressBar(progressBarCheckForAddons, ProgressTone.SUCCESS);
		...
		vBox.add(Box.createVerticalStrut(10));
		{
			...
			UiStyle.applySectionBorder(filesPanel, "Repository changes");
			vBox.add(filesPanel);
		...
		}
		{
			...
			UiStyle.styleProgressBar(progressBarDownloadAddons, ProgressTone.INFO);
		...
		}
		{
			...
			UiStyle.styleProgressBar(progressBarDownloadSingleAddon, ProgressTone.WARNING);
		...
		UiStyle.applySectionBorder(progressPanel, "Progress monitor");
